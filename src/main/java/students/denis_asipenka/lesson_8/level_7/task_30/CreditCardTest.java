...
public class CreditCardTest {
    ...
    void incorrectPinCode() {
        ...
        int deposit = 2000;
        int result = 2000;
        CreditCard creditCard = new CreditCard.CreditCardBuilder(1234, 0001).balance(1000).creditLimited(0).loanDebt(0).builder();
    ...
    void addBalance() {
        ...
        int deposit = 2000;
        int result = 2000;
        CreditCard creditCard = new CreditCard.CreditCardBuilder(1234, 0001).balance(0).creditLimited(1000).loanDebt(0).builder();
    ...
    void addBalanceOne() {
        ...
        int deposit = 2000;
        int result = 1549;
        CreditCard creditCard = new CreditCard.CreditCardBuilder(1234, 0001).balance(0).creditLimited(1000).loanDebt(-451).builder();
    ...
    void cashWithdrawal() {
        ...
        int withdraw = 1000;
        int result = 1000;
        CreditCard creditCard = new CreditCard.CreditCardBuilder(1234, 0001).balance(2000).creditLimited(1000).loanDebt(0).builder();
    ...
    void cashWithdrawalOne() {
        ...
        int withdraw = 2000;
        int result = 0;
        CreditCard creditCard = new CreditCard.CreditCardBuilder(1234, 0001).balance(1000).creditLimited(1000).loanDebt(0).builder();

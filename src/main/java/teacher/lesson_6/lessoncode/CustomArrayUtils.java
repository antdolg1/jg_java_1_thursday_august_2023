...
public class CustomArrayUtils {
    ...
    static void reverseArray(int[] array) {
        if (array == null || array.length == 0) {
            System.out.println("You cannot sort empty or non existing array");
            return;
        }

        int left = 0; //represents the index of the first element in the array
        int right = array.length - 1; //represents the index of last element in the array
